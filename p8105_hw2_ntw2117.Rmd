...
- There are `r nrow(distinct(brfss_data, county))` distinct locations in the dataset. Every state, and the District of Columbia are represented. NEED TO FINSIH THIS QUESTION. 
