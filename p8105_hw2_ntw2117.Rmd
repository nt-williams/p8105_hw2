...
- There are `r nrow(distinct(brfss_data, county))` distinct locations in the dataset. Every state, and the District of Columbia are represented. The state with the most observations is `r max_record$state` with `r max_record$n` observations. 
...
brfss_data %>% 
  ...
  labs(x = "Year", 
       ...
       caption = "Excellent response in New York and Queens County, 2002-2010") + 
  theme_bw()
```
