...
-   There are 404 distinct locations in the dataset. Every state, and the District of Columbia are represented. The state with the most observations isNJ with 146 observations.
